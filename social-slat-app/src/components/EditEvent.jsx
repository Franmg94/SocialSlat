...
export default function EditEvent() {
  ...
  // console.log("Title from useState: ", title);
  // console.log("Time from useState: ", time);
  // console.log("Image from useState: ", image);
  
  
  
  // 
  // I NEED TO PUT ANOTHER DATE EDIT IN THE FORM
  // 
  ...
  <div className="mx-auto max-w-2xl text-center">
    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Edit Event </h2>
    <p className="mt-2 text-lg leading-8 text-gray-600">Update the information of your event.</p>
  </div>
  <form onSubmit={handleFormSubmit} method="PUT" className="mx-auto mt-16 max-w-xl sm:mt-20">
    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">

        {/* TITLE */}
      <div className="sm:col-span-2">
        <label htmlFor="company" className="block text-sm font-semibold leading-6 text-black">Title of the event</label>
      ...
      {/* Description */}
      <div className="sm:col-span-2">
        <label htmlFor="description" className="block text-sm font-semibold leading-6 text-green-600">Description</label>
        <div className="mt-2.5">
          <textarea 
            name="description" 
            id="description" 
      ...
      {/* TIME AND LOCATION */}
      <div>
        <label htmlFor="time" className="block text-sm font-semibold leading-6 text-black">Time</label>
        <div className="mt-2.5">
          <input 
            type="time" 
            name="time" 
      ...
      <div>
        <label htmlFor="location" className="block text-sm font-semibold leading-6 text-black">Location</label>
        <div className="mt-2.5">
          <input 
            type="text" 
            name="location" 
      ...
      {/* IMAGE */}
      <div className="sm:col-span-2">
        <label htmlFor="image" className="block text-sm font-semibold leading-6 text-red-600">Image URL</label>
        <div className="mt-2.5">
          <input 
            type="text" 
            name="image" 
      ...
      {/* CATEGORY */}
      {/* I NEED TO CREATE A VALUE AND USE STATE */}
      <div className="sm:col-span-2">
        <label htmlFor="phone-number" className="block text-sm font-semibold leading-6 text-green-600">Category</label>
        <div className="relative mt-2.5">
          <div className="absolute inset-y-0 left-0 flex items-center">
            <label htmlFor="category" className="sr-only">Country</label>
            <select id="category" name="category" className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
      ...
      <div className="flex gap-x-4 sm:col-span-2">
        ...
        <label className="text-sm leading-6 text-gray-600" id="switch-1-label">
          ...
          <a href="#" className="font-semibold text-red-600"> privacy&nbsp;policy</a>.
        </label>
      </div>
    </div>
    <div className="mt-10">
      <button type="submit" className="block w-full rounded-md bg-cyan-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Update information</button>
    </div>
  </form>
</div>
